...
fvalue = E * E * B * B * H * H * J * J + G * G * C * C * power(L, 0.4e1) + G * G * A ...
* A * power(K, 0.4e1) + E * E * A * A * power(H, 0.4e1) + E * E * C * C * power(J, ...
0.4e1) - 0.2e1 * E * A * H * H * G * C * L * L + 0.2e1 * E * E * A * H * H * C * ...
J * J - 0.2e1 * E * E * C * power(J, 0.3e1) * B * H + 0.2e1 * E * C * C * J * J * ...
G * L * L + 0.2e1 * E * A * A * H * H * G * K * K - 0.2e1 * E * E * A * power(H, ...
...
L * L - 0.2e1 * G * G * B * K * power(L, 0.3e1) * C - 0.2e1 * G * G * B * power(K, ...
0.3e1) * L * A + 0.2e1 * G * G * C * L * L * A * K * K - 0.2e1 * F * E * A * A * ...
power(H, 0.3e1) * K - 0.2e1 * F * E * A * H * K * C * J * J + 0.3e1 * F * E * A * ...
H * H * K * B * J + 0.3e1 * F * A * H * K * K * G * B * L - 0.2e1 * F * A * H * ...
K * G * C * L * L - 0.2e1 * F * A * A * H * power(K, 0.3e1) * G + F * E * B * ...
power(H, 0.3e1) * L * A + 0.3e1 * F * E * B * H * L * C * J * J - F * E * B * B * ...
H * H * L * J - F * B * B * H * L * L * G * K + F * B * H * power(L, 0.3e1) * G * ...
C + F * E * B * K * power(J, 0.3e1) * C - F * E * B * B * K * J * J * H - F * B * ...
B * K * K * J * G * L + 0.3e1 * F * B * K * J * G * C * L * L + F * B * power(K, ...
0.3e1) * J * G * A - 0.2e1 * F * E * C * J * L * A * H * H - 0.2e1 * F * E * C * ...
C * power(J, 0.3e1) * L - 0.2e1 * F * C * C * J * power(L, 0.3e1) * G - 0.2e1 * F * ...
